  ...
  const tasks = [
    {
      ...
      styles: { backgroundColor: '#93c5fd', progressColor: '#3b82f6', progressSelectedColor: '#1e40af' },
      name: "Some Project",
      id: "ProjectSample",
      progress: 25,
      type: "project",
