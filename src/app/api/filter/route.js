...
const collectionName = 'filters'; // Added collection name
...
export async function POST(request) {
    ...
    try {
        ...
        const existingContact = await collection.findOne({ name: { $regex: new RegExp(`^${contactData.email}$`, 'i') }, organizationId: session.data.organizationId });
        if (existingContact) {
