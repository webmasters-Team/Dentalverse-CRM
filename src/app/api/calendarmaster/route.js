...
export async function GET(req) {
    ...
    try {
        const masters = await CalendarMaster.find({ organizationId: session.data.organizationId });
...
export async function POST(request) {
    ...
    const masters = await CalendarMaster.create(masterData);
...
export async function PUT(request) {
    ...
    const updatedMaster = await CalendarMaster.findOneAndUpdate({ organizationId: session.data.organizationId }, updateData, {
        new: true,
        runValidators: true,
    });
