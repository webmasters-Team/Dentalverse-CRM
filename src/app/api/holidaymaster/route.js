...
export async function GET(req) {
    ...
    try {
        const masters = await HolidayMaster.find({ organizationId: session.data.organizationId });
...
export async function POST(request) {
    ...
    const masters = await HolidayMaster.create(masterData);
...
export async function PUT(request) {
    ...
    const updatedMaster = await HolidayMaster.findOneAndUpdate({ organizationId: session.data.organizationId }, updateData, {
        new: true,
        runValidators: true,
    });
