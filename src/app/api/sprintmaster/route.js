...
export async function GET(req) {
    ...
    try {
        const masters = await SprintMaster.find({ organizationId: session.data.organizationId });
...
export async function POST(request) {
    ...
    const masters = await SprintMaster.create(masterData);
...
export async function PUT(request) {
    ...
    const updatedMaster = await SprintMaster.findOneAndUpdate({ organizationId: session.data.organizationId }, updateData, {
        new: true,
        runValidators: true,
    });
