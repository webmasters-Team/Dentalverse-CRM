...
export async function GET(req, res) {
    ...
    try {
        const masters = await ProjectMaster.find({ organizationId: session.data.organizationId });
...
export async function POST(request) {
    ...
    const masters = await ProjectMaster.create(masterData);
...
export async function PUT(request) {
    ...
    const updatedMaster = await ProjectMaster.findOneAndUpdate({ organizationId: session.data.organizationId }, updateData, {
        new: true,
        runValidators: true,
    });
