                                    ...
                                    <div className="pb-3 text-left md:pb-4 md:ml-20 md:mr-2">
                                        ...
                                        <div className="mx-auto max-w-3xl">
                                            <p
                                                className="mb-8 text-gray-700 text-lg"
                                            >
                                                Your project’s success depends on strong relationships with stakeholders. Use our Stakeholder Management tool to build and maintain these relationships throughout your project.
                                            </p>
                                        </div>
                                    </div>
                                </div>
