...
import roadmap from '@/img/pages/plan/roadmap.PNG';
                            ...
                            <div className="mx-4 md:mx-16 flex flex-col md:flex-row">
                                <div className="mt-8 md:mt-0 md:ml-8 text-base md:w-1/2">
                                    <div className="pb-3 text-left md:pb-4 md:ml-2 md:mr-2">
                                        ...
                                        >
                                            Plan Your Project's Journey with the Roadmap
                                        </h1>
                                    ...
                                    <div className="pb-3 text-left md:pb-4 mt-2 md:ml-20 md:mr-2">
                                        ...
                                        <div className="mx-auto max-w-3xl">
                                            <p
                                                className="mb-8 text-gray-700 text-lg"
                                            >
                                                Set and track key milestones to ensure your project stays on course and meets its goals.
                                            </p>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div className="pb-3 text-left md:pb-4 mt-2 md:ml-20 md:mr-2">
                                        ...
                                        <div className="mx-auto max-w-3xl">
                                            <p
                                                className="mb-8 text-gray-700 text-lg"
                                            >
                                                Lay out your project's path from start to finish, with a visual timeline that keeps everyone on the same page.
                                            </p>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div className="pb-3 text-left md:pb-4 mt-2 md:ml-20 md:mr-2">
                                        ...
                                        <div className="mx-auto max-w-3xl">
                                            <p
                                                className="mb-8 text-gray-700 text-lg"
                                            >
                                                Align your team's work with strategic objectives, ensuring every task contributes to your project's success.
                                            </p>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div className="pb-3 text-left md:pb-4 mt-2 md:ml-20 md:mr-2">
                                        ...
                                        <div className="mx-auto max-w-3xl">
                                            <p
                                                className="mb-8 text-gray-700 text-lg"
                                            >
                                                Monitor progress against your roadmap to ensure timely delivery and adjust plans as needed.
                                            </p>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div className="pb-3 text-left md:pb-4 mt-2 md:ml-20 md:mr-2">
                                        ...
                                        <div className="mx-auto max-w-3xl">
                                            <p
                                                className="mb-8 text-gray-700 text-lg"
                                            >
                                                Ensure everyone understands the project direction with a shared, easy-to-follow roadmap.
                                            </p>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div className="mt-8 md:mt-0 md:ml-8 text-base md:w-full">
                                    <div className="pb-3 text-left md:pb-4 md:ml-20 md:mr-2">
                                        <h1
                                            className="mb-6 text-[26px] md:text-[32px] font-semibold  md:leading-tight leading-snug gradientText"
                                        >
                                            Your Project's Path to Success Starts Here
                                        </h1>
                                        <div className="mx-auto max-w-3xl">
                                            <p
                                                className="mb-8 text-gray-700 text-lg"
                                            >
                                                Take control of your project's journey with a clear and actionable roadmap that guides every step of the way.
                                            </p>
                                        </div>
