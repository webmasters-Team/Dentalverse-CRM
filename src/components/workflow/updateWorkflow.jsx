            ...
            <div className="rounded overflow-hidden">
                <div style={{ maxHeight: '100vh', overflowY: 'auto' }}>
                    <div className="sticky top-0 bg-slate-100 z-10">
                        <div>
                            <IconButton onClick={() => { updateIsWorkflowDrawer(false) }} edge="start" color="inherit" aria-label="close">
                    ...
                    <div className="flex justify-center mt-4 min-h-[86vh]">
                        <div>
                            {!loading ? (
                                <div className="mt-10">
                                    <MasterDataComponent masterData={masterData} />
                                </div>
                            ) : (
                    ...
                    <div className="sticky bottom-0 bg-slate-100 z-10 min-h-[60px]">
                        ...
                        <div className="mt-3 mb-3">
                            <div className="flex justify-end mr-4">
                                <div>
                                    <div className="flex">
                                        <button onClick={() => updateIsWorkflowDrawer(false)}
